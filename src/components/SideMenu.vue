    ...
    <div>
        <teleport to="body">
            <Transition name="slide-fade">
                <div
                    v-auto-animate
                    class="navbar-menu fixed top-0 left-0 bottom-0 w-full sm:w-5/6 max-w-max z-50"
                >
                    <div
                        class="navbar-backdrop fixed inset-0 bg-darkGray-800 opacity-80"
                    ></div>
                    <nav
                        class="relative flex flex-col py-20 px-10 h-full w-full bg-blueGray-100 overflow-y-auto"
                    >
                        ...
                        <ul class="mb-16">
                            <li>
                                <a
                                    class="flex items-center pl-10 pr-24 py-4 bg-white rounded-3xl font-medium font-heading"
                                    href="#"
                                >
                                    <img
                                        class="mr-5"
                            ...
                            <li>
                                <a
                                    class="flex items-center pl-10 pr-24 py-4 bg-transparent rounded-3xl font-medium font-heading"
                                    href="#"
                                >
                                    <img
                                        class="mr-5"
                            ...
                            <li>
                                <a
                                    class="flex items-center pl-10 pr-8 w-full py-4 bg-transparent rounded-3xl font-medium font-heading"
                                    href="#"
                                >
                                    <img
                                        class="mr-5"
                        ...
                        <span
                            class="inline-block mb-6 text-sm text-darkBlueGray-400 font-heading font-medium"
                            >New tools</span
                        >
                        <ul class="mb-16">
                            <li>
                        ...
                        <ul class="pb-24 mb-auto">
                            <li>
                                <a
                                    class="text-sm text-darkBlueGray-400 font-heading font-medium leading-8"
                                    href="#"
                                    >About</a
                                >
                            </li>
                        ...
                        <div class="pt-8 border-t border-blueGray-200">
                            <span
                                class="inline-block mb-5 text-sm text-darkBlueGray-400 font-heading font-medium"
                                >Upcoming</span
                            >
                            <a
                                class="flex items-center py-4 px-6 bg-white rounded-3xl shadow-lg text-darkBlueGray-300 hover:text-darkBlueGray-400"
                                href="#"
                            >
                                <img
                                    class="w-10 sm:w-14 h-10 sm:h-14 mr-2 sm:mr-5"
                                    src="/uinel-assets/images/dashboard-navigations/avatar-image.png"
                                    alt=""
                                />
                                <div class="pr-1 mr-auto">
                                    <span
                                        class="block text-sm text-darkBlueGray-900 font-heading font-medium leading-tight"
                                        >Product design</span
                                    >
                                    <span
                                        class="text-xs text-darkBlueGray-300 font-medium leading-tight"
                                        >MON, 8 AM</span
                                    >
                                </div>
                                <svg
