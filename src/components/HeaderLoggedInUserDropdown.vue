<template>
    <a class="flex items-center text-darkBlueGray-400 hover:text-darkBlueGray-500" href="#">
        <div class="mr-6 text-right">
            <span class="block font-heading font-medium leading-tight">keuer</span>
            <span class="font-heading font-medium text-xs text-darkBlueGray-300 uppercase leading-tight">Serverless Free
                Plan</span>
        </div>
        <img class="mr-4" src="/uinel-assets/elements/navigations/avatar-online.png" alt="" />
